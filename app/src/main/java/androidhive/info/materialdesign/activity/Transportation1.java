...
public class Transportation1 extends ActionBarActivity {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for (int i = 0; i < response.getJSONArray("payload").length(); i++) {
                        ...
                        androidhive.info.materialdesign.model.Transportation transportation_model = new androidhive.info.materialdesign.model.Transportation();
