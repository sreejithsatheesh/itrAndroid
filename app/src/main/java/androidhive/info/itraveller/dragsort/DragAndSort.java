...
import androidhive.info.itraveller.activity.HotelActivity;
import androidhive.info.itraveller.adapter.AirportAdapter;
import androidhive.info.itraveller.adapter.PortAndLocAdapter;
import androidhive.info.itraveller.adapter.RearrangePlaceAdapter;
...
*/
   ...
   private DragSortListView.DropListener onDrop = new DragSortListView.DropListener()
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        getSupportActionBar().setTitle("Travel Destination");
